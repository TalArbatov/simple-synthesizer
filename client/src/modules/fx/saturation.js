...
exports.createSaturation = createSaturation;
function createSaturation(audioCtx) {
    ...
    return {
        ...
        set(params) {
            if (params.type !== undefined && params.type !== currentType) {
                ...
                if (currentType === 'soft')
                    waveshaper.curve = makeSoftCurve();
                else if (currentType === 'hard')
                    waveshaper.curve = makeHardCurve();
                else
                    waveshaper.curve = makeWaveCurve();
            }
