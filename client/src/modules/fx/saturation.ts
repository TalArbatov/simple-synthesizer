import type { EffectUnit, SaturationParams } from '../types.js';

export function createSaturation(audioCtx: AudioContext): EffectUnit<SaturationParams> {
  ...
  let currentType: NonNullable<SaturationParams['type']> = 'soft';
